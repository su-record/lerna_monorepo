<template>
  <div :class="classes">
    <input
      ...
      type="checkbox"
      :id="uid"
      :checked="modelValue === CHECKED_STRING.TRUE"
      @click="update"
    />
...
import { CHECKED_STRING } from "@/constants/const";
...
const update = function (ev: InputEvent): void {
  ...
  emit("update:modelValue", el.checked ? CHECKED_STRING.TRUE : CHECKED_STRING.FALSE);
};

const classes = computed(() => ({
  "check-box": true,
  "check-box--slide": props.slide,
  "check-box--square": props.square,
}));
</script>
